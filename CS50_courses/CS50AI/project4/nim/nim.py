...
class NimAI:
    ...
    def get_q_value(self, state, action):
        ...
        """
        # check if state, action is part of self.q
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        """
        # following the formula, where new value is reward + future_rewards
    ...
    def best_future_reward(self, state):
        ...
        for action in available_actions:
            ...
            # retrieve the q value from self.q_value
            q_value = self.q.get(state_action_pair, 0)

            # updating maximum q value
            if q_value > max_q:
                max_q = q_value
